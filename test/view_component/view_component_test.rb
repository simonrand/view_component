...
class ViewComponentTest < ViewComponent::TestCase
  ...
  def test_renders_child_inline_variant_template_when_variant_template_is_not_present
    with_variant :inline_variant do
  ...
  def test_renders_child_inline_variant_template_when_variant_template_is_not_present
    with_variant :inline_variant do
      ...
      assert_not_predicate InlineVariantChildWithTemplateComponent, :inlined?
      assert_selector("div", text: "hello,world!")
    end
  end
